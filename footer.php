    ...
    <!-- <footer>
        <ul>
            ...
            <li><a href="<?php echo home_url('/contact/'); ?>">主催団体様<br class="brpc_none">お問い合わせ</a></li>
            <li><a href="<?php echo home_url('/privacy_policy/'); ?>">プライバシーポリシー・<br class="brpc_none">免責事項</a></li>
        </ul>
                ...
                <ul class="footer_navflex">
                    ...
                    <li class="footer_navitemwrap">
                        ...
                        <ul class="footer_navitem">
                            ...
                            <li><a href="<?php echo home_url('/contact/'); ?>">主催団体様<br>お問い合わせ</a></li>
                        </ul>
                    </li>
                    <li class="footer_navitemwrap">
                        <p>記事</p>
